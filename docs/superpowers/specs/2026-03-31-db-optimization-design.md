...
| announcement                 | ✅        | ✅       | ❌          | 부분사용 |
| inquiry                      | ✅        | ✅       | ❌          | 부분사용 |
| center_director              | ✅        | ✅       | ❌          | 부분사용 |
| teacher                      | ✅        | ✅       | ✅          | 사용중   |
| customer                     | ✅        | ✅       | ❌          | 부분사용 |
| user_search_selected_teacher | ✅        | ✅       | ❌          | 부분사용 |

_분석 스크립트(`backend/scripts/analyze_db_usage.py`) 실행 결과 반영 (2026-03-31). 프론트 호출은 `frontend/src/` 내 `.js`/`.vue` 파일 기준._
