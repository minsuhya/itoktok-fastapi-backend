...
from ..models.program import SEOUL_TZ, Program
...
def get_programs(
    ...
    data = paginate(session, query)
    print("get_programs data", data)
    return data
    # return paginate(session, query)


def update_program(
    session: Session, program: ProgramUpdate, db_program: Program
) -> Program:
