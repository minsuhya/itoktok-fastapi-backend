    ...
    <div className="w-full bg-neutral-50 shadow-lg rounded-lg p-6">
      <div className="border-b pb-2 mb-4">
        ...
        <div class="grid grid-cols-1 gap-y-6">
          ...
          <div
            v-for="(hour_schedule, hour) in schedule_data"
            :key="hour"
          ...
          >
            ...
            <div class="w-full">
              <div
                v-for="(minute_schedule, minute) in hour_schedule"
                :key="minute"
                class="flex items-center justify-between w-full"
              >
                <div
                  class="flex-row text-xs text-blue-600 border border-blue-700/10 rounded-md m-1 space-y-1 w-full"
                  v-for="(day_schedule, itemindex) in minute_schedule"
                  :key="itemindex"
                  :class="[
