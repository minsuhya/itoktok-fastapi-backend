...
<template>
  <!-- Background overlay -->
  <div @click="$emit('close')" class="fixed inset-0 bg-black bg-opacity-50 transition-opacity duration-1000"
      ...
      <div className="border-b pb-2 mb-4">
        ...
        <Form :validation-schema="schema" @submit="onSubmit">
          <div class="mb-4">
            ...
            <Field as="select" name="timeInterval" id="timeInterval"
          ...
          <div class="mb-4">
            <div class="flex items-center justify-between">
              <label for="hs-color-input" class="block text-sm font-medium mb-2">일정 색상 </label>
              <Field type="color" name="usercolor" id="usercolor"
          ...
          <div class="flex justify-between mt-4">
            <button type="button" @click="$emit('close')" class="bg-gray-400 text-white rounded-md p-2 w-[80px]">
              취소
            </button>
